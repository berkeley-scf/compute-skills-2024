...
This module introduces you to Python, making heavy use of [this Software Carpentry lesson](https://swcarpentry.github.io/python-novice-inflammation).
:::
...
We'll use [this Software Carpentry lesson](https://swcarpentry.github.io/python-novice-inflammation) for most of this material.

## 1. Python Fundamentals

We'll work through the [Python Fundamentals section](https://swcarpentry.github.io/python-novice-inflammation/01-intro.html) of the Software Carpentry workshop. The primary ideas covered are variables, data types, and basic function usage.
...
We'll work through the [Analyzing Patient Data section](https://swcarpentry.github.io/python-novice-inflammation/02-numpy.html) of the Software Carpentry workshop. The primary ideas covered are libraries (aka packages), numpy arrays, and slicing.

::: {.callout-tip}
## Exercise 1

Work on the [questions about slicing in the section](https://swcarpentry.github.io/python-novice-inflammation/02-numpy.html#slicing-strings).
:::
...
We'll work through the [Visualizing Tabular Data section](https://swcarpentry.github.io/python-novice-inflammation/03-matplotlib.html) of the Software Carpentry workshop. The primary ideas covered are making basic plots using the `matplotlib` package.
...
We'll work through the [Storing Multiple Values in Lists section](https://swcarpentry.github.io/python-novice-inflammation/04-lists.html) of the Software Carpentry workshop. The primary ideas covered are creating, extracting from, and manipulating lists.
...
- Figure out some different ways of combining your list of numbers with your list of strings to create a single list of mixed type elements. (Hint: you can type `x.` followed by the `<Tab>` key in a Notebook or at the IPython prompt to find the various methods that can be applied to a list.)
...
Answer the [question related to Overloading](https://swcarpentry.github.io/python-novice-inflammation/04-lists.html#overloading) in the Software Carpentry section.
...
We'll work through the [Repeating Actions with Loops section](https://swcarpentry.github.io/python-novice-inflammation/05-loop.html) of the Software Carpentry workshop. The primary ideas covered relate to using `for` loops to automate operations.
...
We'll work through the [Making Choices section](https://swcarpentry.github.io/python-novice-inflammation/07-cond.html) of the Software Carpentry workshop. The primary ideas covered are using conditionals (if-then-else statements) and boolean (logical) operations.

::: {.callout-tip}
## Exercise 1

Answer [this question](https://swcarpentry.github.io/python-novice-inflammation/07-cond.html#what-is-truth) from the Software Carpentry section.
...
Answer [this question](https://swcarpentry.github.io/python-novice-inflammation/07-cond.html#counting-vowels) from the Software Carpentry section.

:::

## 8. Creating Functions

We'll work through the [Creating Functions section](https://swcarpentry.github.io/python-novice-inflammation/08-func.html) of the Software Carpentry workshop. The primary ideas covered are defining, using, testing, and debugging functions.
...
Define a function called `sqrt` that will take the squae root of a number and will (if requested by the user) set the square root of a negative number to 0.
...
Answer the [question related to local vs. global variables](https://swcarpentry.github.io/python-novice-inflammation/08-func.html#variables-inside-and-outside-functions) in the Software Carpentry section.

:::

## 9. Errors and Exceptions 

We'll work through the [Errors and Exceptions section](https://swcarpentry.github.io/python-novice-inflammation/09-errors.html) of the Software Carpentry workshop. The primary ideas covered are understanding error messages and tracebacks and writing your own code that handles errors.

::: {.callout-tip}
## Exercise 1

Answer [this question](https://swcarpentry.github.io/python-novice-inflammation/09-errors.html#reading-error-messages) from the Software Carpentry section.
...
- [Syntax errors](https://swcarpentry.github.io/python-novice-inflammation/09-errors.html#identifying-syntax-errors)
- [Name errors](https://swcarpentry.github.io/python-novice-inflammation/09-errors.html#identifying-variable-name-errors)
- [Index errors](https://swcarpentry.github.io/python-novice-inflammation/09-errors.html#identifying-index-errors)
