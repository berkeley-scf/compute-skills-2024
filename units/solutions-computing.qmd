...
```bash
cp -pr assets assets_copy             # short form
cp --recursive -p assets assets_copy  # long form plus short form
cp -recursive -p assets assets_copy   # incorrect long form
cp -r -e -c -u -r -s -i -v -e -p assets assets_copy
```
