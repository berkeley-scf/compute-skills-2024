...
Note that GitHub will probably prompt you to authenticate using 2-Factor Authentication (e.g., via the Google Authenticator app on your phone). Hopefully you were prompted to set this up when you created your GitHub account. We'll try to help if you run into problems here.
